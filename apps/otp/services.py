...
def request_otp(raw_phone: str, purpose: str) -> dict:
    """Create + send an OTP, enforcing cooldown and hourly cap. Raises DomainError."""
    ...
    if not get_provider().send_otp(phone, code):
        raise DomainError(
